...
data_dir <- "/Users/vinayakbagdi/Downloads/ssp585_hurs"
...
output_file <- file.path(output_dir, "combined_ssp585_hurs.csv")
...
data_dir <- "/Users/vinayakbagdi/Downloads/ssp585_tas"
output_dir <- "/Users/vinayakbagdi/Downloads/"
...
output_file <- file.path(output_dir, "combined_ssp585_tas.csv")
write_csv(final_data, output_file)
message("Combined data saved to: ", output_file)
...
input_file <- "/Users/vinayakbagdi/Downloads/combined_ssp585_tas.csv"
output_file <- "/Users/vinayakbagdi/Downloads/converted_ssp585_tas.csv"
